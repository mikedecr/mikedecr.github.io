...
Save this file. In your `ps811` folder on your computer (which you should have...), create a section for R containing a "lessons" folder. Save this document in `811/R/lessons/`.^[This notation signifies a folder directory pathway. Slashes indicate folders.] 
