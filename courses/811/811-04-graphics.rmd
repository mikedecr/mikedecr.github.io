...
knitr::include_graphics("/images/811/kp-fig-1.png")
```
...
There are many extensions for `ggplot` that you can install. Rather than tediously describe them, I'll point you to a [web page](https://exts.ggplot2.tidyverse.org/) discussing many of the tools out there. These let you create heatmaps, choropleths, network graphs, mosaic plots, autocorrelation plots, and much more. Extensions I have used in the past include `ggfortify`, `ggridges`, `ggthemes`, `ggsci`, `GGally`, and `ggalt`.
