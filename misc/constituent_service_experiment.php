...
$featurearray = array("Chamber" => array("House of Representatives","Senate"),"Political Party" => array("Democratic","Republican"),"Length of Service" => array("2 years","12 years","20 years"),"Committee" => array("Agriculture","Budget","Judiciary","Veterans' Affairs"),"Former Occupation" => array("Small business owner","Public school teacher","Lawyer","State legislator"),"Gender" => array("Female","Male"),"Staff Member to Contact" => array("Abbey Krueger","Molly O'Connell","Lindsay Novak","Emily Schmitt","Rebekah Klein","Meghan Muller","Tamika Jackson","Aisha Mosley","LaTanya Dorsey","Althea Jefferson","Jamila Charles","Keisha Banks","Yesenia Orozco","Marisela Vazquez","Ana Rodriguez","Juana Garcia","Isabel Avalos","Maria Hernandez","Allie Nguyen","Madeline Yang","Jessica Huang","Nicole Chen","Audrey Wu","Cara Xiong"));
