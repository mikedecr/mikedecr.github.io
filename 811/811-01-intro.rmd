...
5. These points are in service of *making R fun and rewarding.* Because R is a more technically flexible programming language than some alternatives (Stata, SPSS, SAS), many introductions to R focus too heavily "eating your vegetables" about how the language works instead of showing what it can do (though we have to eat *some* veggies). I can never design a short course to make you an expert in R, but I can design a short course that helps you create some awesome stuff from the get-go.
